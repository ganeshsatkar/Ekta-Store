...
public class CartListAdapter extends RecyclerView.Adapter<CartListViewHolder> {
    ...
    public CartListViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(context).inflate(grdp.emart.store.R.layout.cart_list_items, null);
    ...
    public void onBindViewHolder(final CartListViewHolder holder, final int position) {
        if (position == productList.size() - 1) {
            ...
            holder.txtGurantee.setText(Html.fromHtml(context.getResources().getString(grdp.emart.store.R.string.secure_payment_text)));
        ...
        popupMenu.getMenuInflater().
                ...
                inflate(grdp.emart.store.R.menu.textview_popup_menu, popupMenu.getMenu());
