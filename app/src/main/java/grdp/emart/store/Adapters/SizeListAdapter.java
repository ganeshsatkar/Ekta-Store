...
public class SizeListAdapter extends RecyclerView.Adapter<SizeListAdapter.MyViewHolder> implements View.OnClickListener {
    ...
    public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        View v = LayoutInflater.from(parent.getContext()).inflate(grdp.emart.store.R.layout.size_list_items, parent, false);
    ...
    public class MyViewHolder extends RecyclerView.ViewHolder {
        ...
        @BindView(grdp.emart.store.R.id.size)
        TextView size;
        @BindColor(grdp.emart.store.R.color.gray)
        int gray;
        @BindColor(grdp.emart.store.R.color.colorPrimary)
        int colorPrimary;
