    ...
    public void onBindViewHolder(final HomeProductsViewHolder holder, final int position) {
        ...
        try {
            Picasso.with(context)
                    ...
                    .resize(Integer.parseInt(context.getResources().getString(grdp.emart.store.R.string.targetProductImageWidth)),Integer.parseInt(context.getResources().getString(grdp.emart.store.R.string.targetProductImageHeight)))
                    .into(holder.image);
        } catch (Exception e) {
