...
public class SplashScreen extends Activity {
    ...
    String id = "";
    @BindView(grdp.emart.store.R.id.errorText)
    TextView errorText;
    @BindView(grdp.emart.store.R.id.internetNotAvailable)
    LinearLayout internetNotAvailable;
    @BindView(grdp.emart.store.R.id.splashImage)
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(grdp.emart.store.R.layout.activity_splash_screen);
    ...
    @OnClick(grdp.emart.store.R.id.tryAgain)
    public void onClick() {
        if (DetectConnection.checkInternetConnection(getApplicationContext())) {
