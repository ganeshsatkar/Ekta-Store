...
public class SignUp extends AppCompatActivity {
    ...
    @BindViews({grdp.emart.store.R.id.username, grdp.emart.store.R.id.email, grdp.emart.store.R.id.password, grdp.emart.store.R.id.confirmPassword})
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(grdp.emart.store.R.layout.activity_signup);
    ...
    @OnClick({grdp.emart.store.R.id.txtSignIn, grdp.emart.store.R.id.signUp, grdp.emart.store.R.id.back})
    public void onClick(View view) {
        switch (view.getId()) {
            case grdp.emart.store.R.id.txtSignIn:
