...
import grdp.emart.store.Adapters.HomeCategoryAdapter;
import grdp.emart.store.Adapters.HomeCategoryProductsAdapter;
import grdp.emart.store.Adapters.MyPagerAdapter;
import grdp.emart.store.Config;
import grdp.emart.store.DetectConnection;
import grdp.emart.store.MVP.CategoryListResponse;
import grdp.emart.store.MVP.Product;
import grdp.emart.store.MVP.SliderListResponse;
...
public class Home extends Fragment {
    ...
    @BindView(grdp.emart.store.R.id.categoryProductRecyclerView)
    ...
    @BindString(grdp.emart.store.R.string.app_name)
    String app_name;
    @BindView(grdp.emart.store.R.id.sliderLayout)
    LinearLayout sliderLayout;
    public static SwipeRefreshLayout swipeRefreshLayout;
    @BindView(grdp.emart.store.R.id.linearLayout)
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        view = inflater.inflate(grdp.emart.store.R.layout.fragment_home, container, false);
        ButterKnife.bind(this, view);
        MainActivity.title.setText(app_name);
        activity = (Activity) view.getContext();
        dotsRecyclerView = (RecyclerView) view.findViewById(grdp.emart.store.R.id.dotsRecyclerView);
        nestedScrollView = (NestedScrollView) view.findViewById(grdp.emart.store.R.id.nestedScrollView);
        setCategoryData();
        ...
        swipeRefreshLayout = (SwipeRefreshLayout) view.findViewById(grdp.emart.store.R.id.simpleSwipeRefreshLayout);
